     ...
     --}}
      ...
      <body>
        <div>
            ...
            <h4 class="mb-5 text-white"> A D M I N </h4>
            <li>
            ...
            <li>
              <a class="text-white" href="alumni">
                <i class="bi bi-people"></i>
                  Data Alumni
              </a>
            </li>
            <li>
              <a class="text-white" href="perusahaan">
                <i class="bi bi-wallet2"></i> 
                Perusahaan
              </a>
            </li>
            <li>
              <a class="text-white" href="lowongan">
                <i class="bi bi-pencil-square"></i>
                  Lowongan
              </a>
            </li>
            <li> <a class="text-white" href="lamaran">
              <i class="bi bi-pencil-square"></i>
                Lamaran
            </a>
          </li><li> <a class="text-white" href="approvals">
            <i class="bi bi-pencil-square"></i>
              Approve
          </a>
        </li>
    ...
    <html lang="en">
      ...
      <body>
        <div>
            ...
            <li>
              <a class="text-white" href="lamaran">
                <i class="bi bi-pencil-square"></i>
                  Lamaran
              </a>
            </li>
            <li>
              <a class="text-white" href="approvals">
                <i class="bi bi-pencil-square"></i>
                  Approval
              </a>
            </li>
