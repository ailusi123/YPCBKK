    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="blog">Perusahaan</a></li>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Lowongan Perusahaan</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">List Perusahaan yang bekerja sama dengan pihak BKK SMK YPC Tasikmalaya</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4">
            ...
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                ...
                {{-- <img src="{{ asset('SoftLand/assets/img/img_1.jpg') }}" alt="Image" class="img-fluid"> --}}
              </a>
              <div class="post-text">
                <h3><a href="/lamaran/add">{{ $item->nama }}</a></h3>
                <h5>{{$item->telepon}}</h5>
                <h5>{{$item->alamat}}</h5>
          ...
          {{-- <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                <img src="{{ asset('SoftLand/assets/img/img_2.jpg') }}" alt="Image" class="img-fluid">
              </a> --}}
              {{-- <div class="post-text">
                <span class="post-meta">December 13, 2019 &bullet; By <a href="#">Admin</a></span>
                <h3><a href="#">Chrome now alerts you when someone steals your password</a></h3>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                <img src="{{ asset('SoftLand/assets/img/img_3.jpg') }}" alt="Image" class="img-fluid">
              </a>
              <div class="post-text">
                <span class="post-meta">December 13, 2019 &bullet; By <a href="#">Admin</a></span>
                <h3><a href="#">Chrome now alerts you when someone steals your password</a></h3>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <a href="blog-single.html" class="d-block mb-4">
                <img src="{{ asset('SoftLand/assets/img/img_4.jpg') }}" alt="Image" class="img-fluid">
              </a>
              <div class="post-text">
                <span class="post-meta">December 13, 2019 &bullet; By <a href="#">Admin</a></span>
                <h3><a href="#">Chrome now alerts you when someone steals your password</a></h3>
