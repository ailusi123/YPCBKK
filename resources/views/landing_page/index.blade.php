    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          {{-- <li><a href="pricing">Perusahaan</a></li> --}}
          <li><a href="blog">Perusahaan</a></li>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">Selamat Datang di BKK  SMK YPC Tasikmalaya</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Temukan pekerjaan sesuai dengan keinginanmu.</p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="#" class="btn btn-outline-white">Get started</a></p>
            </div>
            <div class="col-lg-4 iphone-wrap">
              {{-- <img src="{{asset('SoftLand/assets/img/bkk (1).png')}}" alt="Image" class="phone-1" data-aos="fade-right"> --}}
              <img src="{{asset('SoftLand/assets/img/bkk (1).png')}}" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="100">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-4 ms-auto order-2">
            <h2 class="mb-4">TUJUAN:</h2>
            <p class="mb-1">1.Sebagai wadah dalam mempertemukan tamatan dengan pencari kerja.</p>
            <p class="mb-1">2.Memberikan layanan kepada tamatan sesuai dengan tugas dan fungsi masing-masing seksi yang ada dalam BKK.</p>
            <p class="mb-1">3.Sebagai wadah dalam pelatihan tamatan yang sesuai dengan permintaan pencari kerja.</p>
            <p class="mb-1">4.Sebagai wadah untuk menanamkan jiwa wirausaha bagi tamatan melalui pelatihan.
            </p>
          </div>
